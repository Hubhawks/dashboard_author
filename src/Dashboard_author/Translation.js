  ...
  const container = window !== undefined ? () => window().document.body : undefined;
    ...
    <Box component='form' encType="multipart/form-data"
      method="post"  onSubmit={handleSubmit}  sx={{ m: "50px" }}>
			...
			<Typography>What language is  your content in? </Typography>		  
		<label htmlFor="field-rain">
				...
				<Button label="Adventurous" 
				  ...
				  <Grid container>
					  <Grid item>
						  <Typography>What is the word count of your book?</Typography>
        ...
        />
				...
				<Grid item>
						  ...
						  <Typography>What kind of translation do you want?  </Typography>		  
		<label htmlFor="field-rain">
                    <input
                        {...register("EditingType")}
                        type="radio"
