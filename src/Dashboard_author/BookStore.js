...
//   );
  ...
  const container = window !== undefined ? () => window().document.body : undefined;
    ...
    <Box component='div'   sx={{ marginLeft: "350px" }}>
			...
			<Typography>Which is your preferred book store?</Typography>
				</Grid>
				<Grid item xs={6} sx={{
...
borderRadius: '22px'}}>	
        ...
        />
			...
			<Grid container xs={12}>
			 <Grid item  xs={12} sx={{textAlign:'initial'}} >
					<Typography>Who is the publisher of your book?</Typography>
				</Grid>
				<Grid item xs={6}>
						  <TextField 
							 required
        ...
        />
			...
			<Grid container xs={12}>
			 <Grid item>
						  <Typography>How many stores would you like to get your book placed at?</Typography>
						  <TextField 
							 required
							 id="Summary"
							 name="Summary"
        ...
        />
			...
			<Grid container xs={12}>
				<Grid item xs={12} sx={{textAlign:'initial'}}>
				<Typography>What kind of promos are you looking for? </Typography>	
				</Grid>
