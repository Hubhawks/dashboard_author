...
function AmazonAds(props, status, r, profile) {
    ...
    <Box component='form' encType="multipart/form-data"
      method="post"  onSubmit={handleSubmit}  sx={{ m: "50px" }}>
        ...
        />
			...
			<Typography>Do you want your own dashboard? </Typography>		  
		<label htmlFor="field-rain">
			...
			<Typography>What is your approximate advertising budget?</Typography>
					  <label htmlFor="advt">
                    <input
                        {...register("EditingType")}
                        type="radio"
