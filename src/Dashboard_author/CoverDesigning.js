...
function CoverDesigning(props, status, r, profile) {
  ...
  const container = window !== undefined ? () => window().document.body : undefined;
    ...
    <Box component='form' encType="multipart/form-data"
      method="post"  onSubmit={handleSubmit}  sx={{ m: "50px" }}>
			...
			{/* <Typography>What type of editing are you looking for? </Typography>		  
		<label htmlFor="field-rain">
				...
				<Button label="Adventurous" 
				  ...
				  <Grid container>
					  <Grid item>
						  <Typography>What is the “Title of the Story”?</Typography>
				  ...
				  <Grid container>
					  <Grid item>
						  <Typography>What is the summary of the Story?</Typography>
						  <TextField 
							 required
							 id="Summary"
							 name="Summary"
