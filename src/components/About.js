	...
	return (<>
		...
		<Grid container xs={12}  >
			<Grid container xs={6}sx={{margin:"50px"}}>
				...
				<Grid item xs={12}>
					<Typography variant='h1' sx={{textAlign:'initial',fontWeight:800,fontSize:'60px',lineHeight: '72px',fontStyle: 'normal'}}>One-stop literary marketplace for <Typography variant='h1' sx={{color:'red',fontWeight:800,fontSize:'60px',lineHeight: '72px',fontStyle: 'normal'}}>every book-related service</Typography></Typography>
				</Grid>
				<Grid item xs={12}>
					<Typography variant='h1' sx={{width: '659px',height: '131px',fontSize: '18px',lineHeight: '28px',color: '#333335',textAlign:'initial'}}>Hubhawks is your go-to platform, that has all the book-related service providers and people seeking the same. The centralized solution to the literary problems a person can face. It is convenient, user-friendly, and a blessing in disguise for budding authors and the ones who are seeking to add more to their lists.</Typography>
					</Grid>
					
			</Grid>
			<Grid container xs={1}  sx={{marginTop:'100px'}}>
			<CardMedia
					component="img"
					height="194"
...
height: '84px',
		...
		{/* icon with button */}
			...
			<Grid container xs={12} >
					<Grid container xs={4} sx={{ ml:'32px'}} >
...
height: '250px'
			...
			<Grid item xs={12} >
				...
				<Grid container xs={4} sx={{marginTop:'50px'}}>
					<Grid item xs={6} sx={{marginTop:'20px',marginBottom:"20px",margin:'auto'}}>
					<Image src="https://drive.google.com/uc?export=view&id=1Ddsb7YSl-C1q5rtvGoqzK844qoUYAope" style={{
justifyContent:'space-around',borderRadius:'20px',width: '250px',
height: '250px'
			  }}></Image>
					</Grid>
...
lineHeight: '48px'}}>Hubhawks's Cultural Benefits</Typography>
			...
			<Grid container  spacing={2} sx={{m:'50px'}} >
						...
						<Card sx={{
							display: "flex",background: '#BB00000A',width:"365px",height:'104px',margin:'auto'
}}>
       <CardMedia
          component="img"
        ...
        <CardContent sx={{ flex: "1 0 auto" ,margin:"auto"}}>
          <Typography component="div" variant="h4"  sx={{textAlign:'initial',fontSize:"18px",fontWeight:'600',color:'#333335',width:'189px',height:'48px'}}>
            Author-friendly and centric
				...
				<Card sx={{ display: "flex",background: '#BB00000A',width:"365px",height:'104px',margin:'auto' }}>
       <CardMedia
          component="img"
          sx={{ width: 60,height:60,margin:'auto'}}
